<%-- 
    Document   : stats_page
    Created on : 25-Apr-2021, 18:32:16
    Author     : Jesus Larez
--%>
...
<%@page import="entities.StatsSingletonRemote"%>
...
<body>
    ...
    <h1>This is the stats view</h1>
    <%
        HashMap<String, Integer> stats;
        stats = (HashMap<String, Integer>) session.getAttribute("stats");
